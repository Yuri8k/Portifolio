<template>
  <section class="contact section" id="contact">
    <h3 class="section__subtitle">Entrar em <span>contato</span></h3>
    ...
    <div class="contact__container container grid">
      ...
      <form @submit.prevent="sendEmail" class="contact__form" id="contact--form">
        <div class="contact__group">
            ...
            <input type="email" name="user_email" required placeholder="Coloque seu email" class="contact__input">
        </div>

        <textarea name="user_project" required placeholder="Escreva sua mensagem" class="contact__input"></textarea>
