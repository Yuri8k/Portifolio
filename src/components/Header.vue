  ...
  <header class="header" id="header">
    <nav class="nav container">
      ...
      <div :class="active ? 'show-menu' : 'close-menu'" class="nav__menu" id="nav-menu">
        <ul class="nav__list">
          <li class="nav__item">
            <a @click="active = !active" href="#home" class="nav__link">Home</a>
          </li>
          <li class="nav__item">
            <a @click="active = !active" href="#about" class="nav__link">About</a>
          </li>
          <li class="nav__item">
            <a @click="active = !active" href="#skills" class="nav__link">Skills</a>
          </li>
          <li class="nav__item">
            <a @click="active = !active" href="#projects" class="nav__link">Projects</a>
          </li>
          <li class="nav__item">
            <a @click="active = !active" href="#contact" class="nav__link">Contact</a>
          </li>
        </ul>
